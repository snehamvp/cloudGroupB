...
sleep 2s
ssh groupb@groupb13 "ssh hduser@hdfsMaster \"/usr/local/hadoop/sbin/stop-yarn.sh; /usr/local/hadoop/sbin/stop-dfs.sh; jps; sleep 5s; sudo shutdown -P now\"; ssh hduser@hdfsSlave8 \"sudo shutdown -P now\"; ssh hduser@hdfsSlave9 \"sudo shutdown -P now\"; exit"
