...
echo -e "\n Starting storagenode 18,19 and 17"
sleep 15s
ssh groupb@groupb13 "virsh start storageNode18; sleep 5s; ssh swift@storageNode18 \"swift-init all start; exit;\"; virsh start storageNode19; sleep 5s; ssh swift@storageNode19 \"swift-init all start; exit;\"; virsh start storageNode17; sleep 5s; ssh swift@storageNode17 \"swift-init all start; exit;\";exit"
